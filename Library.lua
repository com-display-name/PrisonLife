--[[
    /comment - credit to https://github.com/sametexe001/sametlibs/blob/main/Scoot/Library.lua

	-- changelog: added GameProcessed to UserInputService.InputBegan events (all of them) 
...
local Library do
    ...
    local Instances = { } do
        ...
        Instances.MakeDraggable = function(self)
            ...
            self:Connect("InputBegan", function(Input, GP)
        ...
        Instances.MakeResizeable = function(self, Minimum, Maximum)
            ...
            ResizeButton:Connect("InputBegan", function(Input, GP)
                if GP then return end
                if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
    ...
    local Components = { } do
        ...
        Components.Slider = function(self, Data)
            ...
            Items["RealSlider"]:Connect("InputBegan", function(Input, GP)
                if GP then return end
                if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
                    Slider.Sliding = true 
        ...
        Components.Colorpicker = function(self, Data) -- poetry warning (╯°□°)╯
            ...
            Items["Palette"]:Connect("InputBegan", function(Input, GP)
                if GP then return end
                if Input.UserInputType == Enum.UserInputType.MouseButton1 then
                    SlidingPalette = true 
            ...
            Items["HueInline"]:Connect("InputBegan", function(Input, GP)
                if GP then return end
                if Input.UserInputType == Enum.UserInputType.MouseButton1 then
                    SlidingHue = true 
            ...
            Items["Alpha"]:Connect("InputBegan", function(Input, GP)
                if GP then return end
                if Input.UserInputType == Enum.UserInputType.MouseButton1 then
                    SlidingAlpha = true 
    ...
    Library.Sections.Toggle = function(self, Data)
        ...
        function NewToggle:Keybind(Data)
            ...
            local NewKeybind, KeybindItems = Components:Keybind({
                ...
                Callback = function(Value)
                    ToggleRef:Set(Value)
                    Library:SafeCall(OriginalCallback, Value)
                end
            })

            local OriginalToggleSet = ToggleRef.Set
            ToggleRef.Set = function(_, Value)
                OriginalToggleSet(_, Value)
                if NewKeybind and NewKeybind.Sync then
                    NewKeybind:Sync(Value)
                end
            end
